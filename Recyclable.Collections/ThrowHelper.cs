...
namespace Recyclable.Collections
{
	internal static class ThrowHelper
	{
		...
		public static void ThrowListModifiedException()
		{
			Contract.EnsuresOnThrow<InvalidOperationException>(false);
			throw new InvalidOperationException("Can't move to the next item, because the collection was modified. You must restart the enumeration by calling Reset(), if you want to enumerate the collection again");
		}
		...
		public static void ThrowArgumentOutOfRangeException(in string argumentName, in string message)
		{
