...
namespace Recyclable.Collections.Benchmarks.POC
{
	...
	internal class RecyclableListIndexOfV1<T> : IDisposable, IList<T>
	{
		...
		private static long DoLongIndexOfParallel(in RecyclableListIndexOfV1<T> list, in ItemRange itemRange, in T itemToFind, in ManualResetEventSlimmer itemFoundSignal)
		{
			int blockSize = list._blockSize;
